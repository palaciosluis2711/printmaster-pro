...
export default function GridCanvas({
    ...
    const layout = useMemo(() => {
        ...
        const totalGapWidth = (config.gap || 0) * (cols - 1);
        const cellWMm = (contentWidth - totalGapWidth) / cols;
        const totalGapHeight = (config.gap || 0) * (rows - 1);
        const cellHMm = (contentHeight - totalGapHeight) / rows;
