...
export default function Sidebar({
  ...
  const renderHome = () => (
    <div className="grid grid-cols-2 gap-3 p-1">
      ...
      <button onClick={() => navigateTo('favorites')} className="aspect-square bg-amber-50 hover:bg-amber-100 rounded-xl flex flex-col items-center justify-center gap-2 border-2 border-amber-100 hover:border-amber-300 transition-all group">
        <Star className="w-8 h-8 text-amber-500 group-hover:scale-110 transition-transform" />
        <span className="text-xs font-bold text-amber-700">Favoritos</span>
      </button>
